      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          <View style={styles.ownerOverlay}>
            <Ionicons name="person-circle" size={18} color="#E1FF00" />
        ...
        >
          ...
          <Ionicons name="chevron-forward" size={14} color="#E1FF00" />
        </TouchableOpacity>
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.specsRow}>
            ...
            {car.horsepower ? (
              <View style={styles.specChip}>
                <Ionicons name="flash" size={12} color="#E1FF00" />
          ...
          <View style={styles.actionsRow}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Ionicons name="chatbubble-outline" size={16} color="#E1FF00" />
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
          ...
          {sortOptions.map((option) => (
            ...
            >
              <Ionicons 
                ...
                size={16} 
                color={sortBy === option.key ? '#E1FF00' : '#888'} 
              />
              <Text style={[
              ...
              {sortBy === option.key && (
                <Ionicons name="checkmark" size={16} color="#E1FF00" />
              )}
            </TouchableOpacity>
          ))}
        </View>
      ...
      {loading ? (
        ...
        <View style={styles.errorContainer}>
          <Ionicons name="cloud-offline-outline" size={64} color="#E1FF00" />
