...
export default function ProfileScreen() {
  ...
  const getNotificationColor = (type: string) => {
    switch (type) {
      ...
      case 'rsvp_reminder': return '#E31837';
      ...
      >
            ...
            <View style={styles.carCard}>
              ...
              <View style={styles.carInfo}>
                ...
                <View style={styles.carStatsRow}>
                  ...
                  {userCar.displacement && (
                    <View style={[styles.carDetailRow, { flex: 1 }]}>
                      <Ionicons name="flash" size={16} color="#E31837" />
              ...
              <View style={styles.garageActionRow}>
                <TouchableOpacity style={styles.editCarButton} onPress={() => { setEditingCarId(userCar.id); fetchUserCar(true); setShowCarModal(true); }}>
                  <Ionicons name="pencil" size={16} color="#E31837" />
                    ...
                    {userCars.map((car) => (
                      <TouchableOpacity 
                        ...
                        style={{
                          ...
                          backgroundColor: car.isActive ? 'rgba(225, 85, 0, 0.15)' : '#141414',
                          borderRadius: 10,
                          padding: 12,
                      ...
                      >
                        ...
                        {car.isActive ? (
                          <View style={{ backgroundColor: '#E31837', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 3 }}>
        ...
        <View style={styles.menuSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="calendar" size={20} color="#E31837" />
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/my-events')}>
            <Ionicons name="create" size={24} color="#E31837" />
        ...
        <View style={styles.menuSection}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/timer')}>
            <Ionicons name="timer" size={24} color="#E31837" />
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/timer/my-runs')}>
            <Ionicons name="analytics" size={24} color="#E31837" />
        ...
        {user?.isAdmin && (
          <View style={styles.menuSection}>
            <View style={styles.sectionHeader}>
              <Ionicons name="shield-checkmark" size={20} color="#E31837" />
        ...
        <View style={styles.menuSection}>
          ...
          >
            <Ionicons name="server" size={24} color="#E31837" />
        ...
        <View style={styles.menuSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="map" size={20} color="#E31837" />
        ...
        <View style={styles.menuSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="eye" size={20} color="#E31837" />
        ...
        <View style={styles.menuSection}>
          <View style={styles.sectionHeader}>
            <Ionicons name="chatbubble-ellipses" size={20} color="#E31837" />
